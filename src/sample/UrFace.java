...
public class UrFace {
    ...
    public static void UrFMenu() {
        ...
        Image inpstr = new Image  ("file:UrFace.png");
        ImageView image1= new ImageView(new Image("file:UrFace.png"));
        ...
        Label position = new Label("Юридическое лицо");
        ...
        Button func1 = new Button("открыть рассчётный счёт");
        ...
        Button func2 = new Button("просмотреть мой счёт");
        ...
        Button func3 = new Button("совершить перевод средств");
        ...
        primaryStage.setTitle("Юридическое лицо");
        scene.getStylesheets().add(0, "file:UrFaceMenu.css"); //подключение CSS
        primaryStage.show();
